...
function LoginInfo({handleOpenModal}) {
  return (
    <section className="wrapper-info-login-signup">
      <div className="welcome-info-login-tuitah">
        <ul>
          <li>
          ...
          <li>
            <svg viewBox="0 0 24 24" className="people-svg">
              <g>
            ...
            Hear waht people are talking about.
          </li>
          <li>
        ...
        <svg viewBox="0 0 24 24" className="tuitah-svg-bg-welcome">
          <g>
      ...
      <div className="login-signup-menu">
        <div className="information-login-signup-menu">
          ...
          <h1>
            See what’s happening in <br /> the world on Tuitah
          </h1>
          <div className="menu-login-sign-up">
            <span>Join Tuitah today.</span>
            <a href="#modal" onClick={() => handleOpenModal()}>
              Sign up
            </a>
